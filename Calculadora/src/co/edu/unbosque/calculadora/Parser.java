...
public class Parser {
        ...
        /**
         * Esta es la función que evalúa una expresión parseada en un valor
         * double.
         *
         * @param expresionParseada Esta es una expresión en notación postfija
         * (se puede obtener con la función parsear).
